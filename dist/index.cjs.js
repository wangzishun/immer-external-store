...
function createImmerExternalStore(initialState) {
  ...
  var notify = function notify() {
    return new Set(listeners).forEach(function (sub) {
      return sub();
    });
  };
  ...
  var dispatch = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(recipeOrPartial) {
      var draft;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            draft = immer.createDraft(STATE);
            if (!(typeof recipeOrPartial === 'function')) {
              _context.next = 6;
              break;
            }
            _context.next = 4;
            return recipeOrPartial(draft);
          case 4:
            _context.next = 7;
            break;
          case 6:
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            init = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : initialState;
  ...
  var selectorImpl = function selectorImpl(selectors) {
  ...
  function useState() {
    ...
    return withSelector.useSyncExternalStoreWithSelector(subscribe, getSnapshot, getSnapshot, function () {
      return selectorImpl(Array.from(_arguments));
